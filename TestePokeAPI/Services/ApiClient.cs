...
namespace TestePokeAPI.Services
{
    ...
    {
        /// <summary>
        /// The default `User-Agent` header value used by instances of <see cref="ApiClient"/>.
        /// </summary>
        ...
        /// Default constructor
        /// </summary>
        public ApiClient() : this(DefaultUserAgent) {}

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient"/> with 
        /// a given value for the `User-Agent` header
        /// </summary>
        /// <param name="userAgent">The value for the default `User-Agent` header.</param>
        public ApiClient(ProductHeaderValue userAgent)
        {
            if (userAgent == null)
            {
        ...
        /// <param name="messageHandler">Message handler implementation</param>
        /// <param name="userAgent">The value for the default `User-Agent` header.</param>
        public ApiClient(HttpMessageHandler messageHandler, ProductHeaderValue userAgent)
        {
            if (userAgent == null)
            {
                throw new ArgumentNullException(nameof(userAgent));
